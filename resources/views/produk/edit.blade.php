        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-edit mr-1"></i> Edit Produk</h4>
                ...
                <form action="{{ route('admin.produk.update', $produk) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Info kode produk (read only) --}}
                        <div class="alert alert-light border mb-4">
                            <i class="fas fa-barcode mr-1"></i>
                            Kode Produk: <strong><code>{{ $produk->kode_produk }}</code></strong>
                        </div>
            ...
            'lainnya' => 'Lainnya',
                                                ...
                                                <option value="{{ $value }}"
                                                    {{ old('kategori', $produk->kategori) == $value ? 'selected' : '' }}>
                                                    {{ $label }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3"
                                            placeholder="Keterangan tambahan produk (opsional)">{{ old('deskripsi', $produk->deskripsi) }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                {{-- Stok (read only di edit - ubah lewat pembelian/pengeluaran) --}}
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Stok Saat Ini</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control"
                                            value="{{ number_format($produk->stok) }} {{ $produk->satuan }}" readonly
                                            style="background-color: #f8f9fa;">
                                        <small class="text-muted">Ubah stok lewat menu Pembelian / Pengeluaran
                                            Produk</small>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" name="stok_minimum"
                                            ...
                                            value="{{ old('stok_minimum', $produk->stok_minimum) }}" min="0">
                                        @error('stok_minimum')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="harga_beli"
                                                ...
                                                value="{{ old('harga_beli', $produk->harga_beli) }}" min="0">
                                            @error('harga_beli')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="text-center mb-2">
                                        <img id="preview-foto"
                                            src="{{ $produk->foto ? asset('storage/' . $produk->foto) : asset('img/no-image.png') }}"
                                            alt="Foto Produk" class="img-fluid rounded border"
                                    ...
                                    @if ($produk->foto)
                                        <div class="text-center mb-2">
                                            <small class="text-muted">
                                                <i class="fas fa-check-circle text-success"></i> Foto tersimpan
                                            </small>
                                        </div>
                                    @endif
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="foto" id="foto"
                                            class="custom-file-input @error('foto') is-invalid @enderror" accept="image/*"
                                            onchange="previewImage(this, 'preview-foto')">
                                        <label class="custom-file-label" for="foto">
                                            {{ $produk->foto ? 'Ganti foto...' : 'Pilih foto...' }}
                                        </label>
                                    </div>
                                    @error('foto')
